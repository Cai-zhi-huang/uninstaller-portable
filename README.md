...
> 当前版本：**v0.0.1 (试用版)** ｜ 系统要求：Windows 10 / 11（64 位）

[![Release](https://img.shields.io/badge/release-v0.0.1-blue)](https://github.com/Cai-zhi-huang/uninstaller-portable/releases/tag/v0.0.1)
...
- **GitHub Release（推荐）**：[卸载管理器 v0.0.1 (试用版)](https://github.com/Cai-zhi-huang/uninstaller-portable/releases/tag/v0.0.1)
- **直接下载便携包（zip，约 23 MB）**：[uninstaller-portable.zip](https://github.com/Cai-zhi-huang/uninstaller-portable/releases/download/v0.0.1/uninstaller-portable.zip)
